...
class FeatureTest extends TestCase
{
    ...
    public function testHandleRenderProcessesHtmlFileWithoutYaml(): void
    {
        ...
        $this->assertStringContainsString('<h1>Test Page</h1>', $outputContent);
    ...
    {
        // Create test HTML file with YAML frontmatter
        $htmlContent = <<<HTML
---
title: My Test Page
...
HTML;
    ...
    public function testHandleRenderCreatesOutputDirectories(): void
    {
        ...
        $this->assertTrue($result['processed']);
        $this->assertTrue(is_dir($this->outputDir . '/blog'));
        $this->assertTrue(file_exists($this->outputDir . '/blog/post.html'));
    }

    public function testHandleRenderHandlesInvalidYaml(): void
    {
        // Create HTML file with invalid YAML
        $htmlContent = <<<HTML
---
title: Test
invalid yaml: [
