 ...
 *
 * Usage: php bin/extract_feature.php <FeatureName> <VendorName> <PackageName> <TargetNamespace>
 * Example: php bin/extract_feature.php S3MediaOffload calevans staticforge-s3 "Calevans\\StaticForgeS3"
 */
...
if ($argc < 5) {
    echo "Usage: php bin/extract_feature.php <FeatureName> <VendorName> <PackageName> <TargetNamespace>\n";
    echo "Example: php bin/extract_feature.php S3MediaOffload calevans staticforge-s3 \"Calevans\\\\StaticForgeS3\"\n";
    exit(1);
}
